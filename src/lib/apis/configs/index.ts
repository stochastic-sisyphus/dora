...
export const importConfig = async (token: string, config) => {
	...
	const res = await fetch(`${get(WEBUI_API_BASE_URL)}/configs/import`, {
		method: 'POST',
		headers: {
...
export const exportConfig = async (token: string) => {
	...
	const res = await fetch(`${get(WEBUI_API_BASE_URL)}/configs/export`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getModelsConfig = async (token: string) => {
	...
	const res = await fetch(`${get(WEBUI_API_BASE_URL)}/configs/models`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getBanners = async (token: string): Promise<Banner[]> => {
	...
	const res = await fetch(`${get(WEBUI_API_BASE_URL)}/configs/banners`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
